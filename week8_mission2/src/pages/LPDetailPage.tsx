...
import {
    useUpdateLPMutation,
    useDeleteLPMutation,
} from "../hooks/mutations/useLpMutation.ts";
...
export default function LPDetailPage() {
    ...
    const likeMutation = useLikeMutation(lpid || "");    const commentMutation = useCreateCommentMutation(lpid || "");
    const updateCommentMutation = useUpdateCommentMutation(lpid || "");
    const deleteCommentMutation = useDeleteCommentMutation(lpid || "");
    ...
    const isLiked = lp?.likes?.some((l: any) => l.userId === myId);
    ...
    return (
        <Layout>
            <div className="min-h-screen p-10">
                ...
                {isFetchingNextPage && (
                    <p className="text-center text-gray-400 mt-2">로딩중...</p>
                )}
